...
INSERT INTO `user` VALUES (1,'user1@mycom.com','user1','password1'),(2,'user2@mycom.com','user2','password2'),(3,'user3@mycom.com','user3','password3'),(4,'user4@mycom.com','user4','password4');
